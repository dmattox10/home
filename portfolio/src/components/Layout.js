...
const Layout = (props) => {
  const { navItems, activeItem, setActive, socials, started, finished, onClickResume } = props
  ...
  return (
    <div className='grid'>
      ...
      <article className='module desktop-10 tablet-10'>
        <Content navItems={navItems} activeItem={activeItem} setActive={setActive} started={started} finished={finished} onClickResume={onClickResume} />
      </article>
      <article className='module desktop-1 tablet-1 col'>
        <RColumn />
      </article>
